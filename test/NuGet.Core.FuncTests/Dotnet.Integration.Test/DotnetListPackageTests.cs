...
namespace Dotnet.Integration.Test
{
    ...
    public class DotnetListPackageTests
    {
        ...
        [PlatformTheory(Platform.Windows, Skip = "Enabled after .NET CLI integration for https://github.com/NuGet/Home/issues/9600")]
        [InlineData("", false)]
        ...
        public void DotnetListPackage_VerbositySwitchTogglesHttpVisibility(string args, bool showsHttp)
        {
            ...
            {
                var projectName = "ListPackageProject";
                var source = "https://api.nuget.org/v3/index.json";
                var emptyHttpCache = new Dictionary<string, string>
                {
                    { "NUGET_HTTP_CACHE_PATH", Path.Combine(testDirectory, "v3-cache") },
                };
                ...
                ProjectFileBuilder
                    ...
                    .Build(_fixture, testDirectory.Path);

                var workingDirectory = Path.Combine(testDirectory, projectName);
                _fixture.RestoreProject(workingDirectory, projectName, string.Empty);

                // Act
                var listResult = _fixture.RunDotnet(
                    workingDirectory,
